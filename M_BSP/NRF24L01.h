...
#ifndef C8T6_BALANCE_NRF24L01_H
#define C8T6_BALANCE_NRF24L01_H
...
/** 外部中断配置 */
#define BSP_KEY_EXTI_IRQN              EXTI2_IRQn          // 外部中断2
#define BSP_KEY_EXTI_PORT_SOURCE       GPIOA               // 外部中断端口资源
#define BSP_KEY_EXTI_PIN_SOURCE        GPIO_PIN_2         // 外部中断引脚资源
#define BSP_KEY_EXTI_LINE              EXTI_LINE_2         // 外部中断
#define BSP_KEY_EXTI_IRQHANDLER        EXTI2_IRQHandler    // 外部中断处理函数名
...
#define RF24L01_SET_CS_HIGH( )        spi_set_nss_high( ) // 使用之前定义的宏
#define RF24L01_SET_CS_LOW( )         spi_set_nss_low( )  // 使用之前定义的宏

#define RF24L01_GET_IRQ_STATUS( )     (HAL_GPIO_ReadPin(RF24L01_IRQ_GPIO_PORT, RF24L01_IRQ_GPIO_PIN) == GPIO_PIN_RESET) ? 0 : 1 // IRQ 状态
