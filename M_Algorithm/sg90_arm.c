...
double abs_angle_error_1 = 0;
double abs_angle_error_2 = 0;
double abs_angle_error_3 = 0;
double abs_angle_error_4 = 0;
double abs_angle_error_5 = 0;
double abs_angle_error_6 = 0;
...
{
    servo_control(servo_target_angle_1,servo_target_angle_2,servo_target_angle_3,servo_target_angle_4,0,90);
    HAL_Delay(200);
    servo_control(servo_target_angle_1,servo_target_angle_2,servo_target_angle_3,servo_target_angle_4,0,120);
    HAL_Delay(200);
